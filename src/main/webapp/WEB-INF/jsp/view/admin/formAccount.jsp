...
<div class="container">
	...
	<div>
		...
		<f:form action="${pageContext.request.contextPath}/admin/addAccount"
			...
			<div class="row">
				...
				<div class="col">
					<label>Please select the user Type</label>

					<f:select path="TypeId" multiple="false" size="1"
						class="form-control">
						<f:options items="${TypeList}" itemValue="idType"
							itemLabel="nomType" />
					</f:select>
	...
	<%-- 					<td><c:out value="${a.Type.TypeName}" /></td> --%>
